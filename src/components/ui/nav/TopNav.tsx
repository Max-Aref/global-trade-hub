...
const DEFAULT_LINKS: NavLink[] = [
  ...
  { label: "How It Works", labelAr: "كيف يعمل", href: "#gth-how-it-works" },
        ...
        <div className="flex items-center justify-between border border-white/10 rounded-xl px-4 md:px-5 py-2 backdrop-blur-sm bg-white/[0.02]">
          ...
          <nav className="hidden md:flex items-center gap-7" aria-label="Main navigation">
            {links.map((link) => (
              ...
              >
                {lang === "ar" && link.labelAr ? link.labelAr : link.label}
              </a>
            ))}
          </nav>
          ...
          <div className="flex items-center gap-3">
            ...
            {onLangToggle && (
              <button
                ...
                className="hidden md:flex items-center gap-1 text-xs font-medium text-white/60 hover:text-white transition-colors border border-white/15 rounded-lg px-2.5 py-1.5"
