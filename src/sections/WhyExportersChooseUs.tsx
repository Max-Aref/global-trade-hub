        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='text-center mb-16'>
            ...
            <h3 className='text-2xl md:text-3xl lg:text-4xl font-medium tracking-tight text-white/90 mb-8'>
              Unlock the World&rsquo;s Most Profitable Market — Without the
              Usual Barriers
            </h3>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12'>
            {features.map((feature, index) => (
              <div
                key={index}
                className='group border border-white/15 rounded-xl p-6 hover:border-white/30 transition-all duration-300 bg-gradient-to-br from-[#190d2e] to-black'
              >
                ...
                <p className='text-white/70 ml-14'>{feature.description}</p>
              </div>
            ))}
          </div>
          ...
          <div className='text-center'>
            <Button href='/auth'>Start Exporting Today</Button>
          </div>
        </div>
      </div>
    </section>
