    ...
    >
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(140,69,255,0.3) 0%, transparent 70%)",
            top: "8%",
            left: "8%",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(140,69,255,0.4) 0%, transparent 70%)",
            bottom: "18%",
            right: "12%",
      ...
      <div className='container relative z-10'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-white/60 text-lg max-w-2xl mx-auto leading-relaxed'>
            Direct buyers. Real analytics. Zero fees. Everything you need to
            export — in one place.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
          {CARDS.map((card, index) => {
            ...
            return (
              ...
              >
                <div
                  className='relative h-full border border-white/10 backdrop-blur-lg rounded-2xl overflow-hidden transition-all duration-300 hover:border-brand-500/50 hover:shadow-[0_20px_40px_rgba(140,69,255,0.28)]'
                  style={{
                    background:
